...
export function ErrorScreen({ model, path, identifier, actions, assertive = false, role }: ErrorScreenProps) {
  ...
  return (
    <main id="main-content" className="grid min-h-[100dvh] bg-background px-raibit-lg py-raibit-xxl text-foreground lg:px-raibit-huge">
      <section
      ...
      >
        ...
        <div className="min-w-0 lg:py-raibit-xl">
          ...
          <p className="mt-raibit-lg max-w-2xl text-body-lg text-muted-foreground">{model.description}</p>
          {(path || identifier) && (
