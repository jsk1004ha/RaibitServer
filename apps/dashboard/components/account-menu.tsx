...
export function AccountMenu({ avatarUrl, email, logoutAction, menuPortalContainer, name, organization, role }: AccountMenuProps) {
  ...
  return <DropdownMenu>
    ...
    <DropdownMenuContent align="end" className="w-72" portalContainer={menuPortalContainer}>
      <DropdownMenuGroup>
