...
export const COVERAGE_EVIDENCE = [
  ...
  { id: 'deployment-destructive', risk: 'destructive-failure', spec: 'apps/dashboard/tests/e2e/specs/task-13-operations.spec.ts', marker: 'rollback and cancel preserve exact payloads, return paths, confirmation, and status gating' },
