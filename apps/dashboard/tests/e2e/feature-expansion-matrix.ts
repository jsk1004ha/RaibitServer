...
export const PLATFORM_EXPANSION_MATRIX: readonly PlatformExpansionRow[] = [
  ...
  { id: 'loading-boundary', execution: 'fixture-driver', driver: 'loading-boundary', actor: 'user', route: '/errors/fixtures/loading', role: 'VIEWER', state: 'loading', viewport: PLATFORM_EXPANSION_VIEWPORTS[1], theme: 'system', zoom: 100, accessibility: ['axe', 'screen-reader-announcement'], representativeVisual: false, action: 'Open the loading fixture with its required fixture session.', observedOutcome: 'The main landmark is busy and announces loading.', sourceRefs: ['apps/dashboard/tests/e2e/specs/error-boundaries.spec.ts'] },
