...
export const PLATFORM_EXPANSION_MATRIX: readonly PlatformExpansionRow[] = [
  ...
  { id: 'github-conflict-recovery-contract', execution: 'contract-pending-task41', driver: null, actor: null, route: '/github?step=import', role: 'MAINTAINER', state: 'conflict', viewport: PLATFORM_EXPANSION_VIEWPORTS[4], theme: 'system', zoom: 100, accessibility: ['keyboard', 'screen-reader-announcement', 'axe', 'long-id'], representativeVisual: false, action: 'Await the published Task41 typed-409 recovery driver.', observedOutcome: 'This row is excluded until its selector, idempotency, and recovery fixture contract is composed.', sourceRefs: ['apps/dashboard/tests/e2e/specs/github-lifecycle.spec.ts'] },
];
