...
test('shared document and chrome keep the public light accessibility contract', async () => {
  const [layout, header, footer, pageHeader, actionNavigation, sectionNavigation] = await Promise.all([
    read('app/layout.tsx'),
