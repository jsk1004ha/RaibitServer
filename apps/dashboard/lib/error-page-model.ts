...
export function renderHostedErrorHtml(codeValue: unknown, options: { path?: unknown; identifier?: unknown } = {}): string {
  ...
  return `<!doctype html><html lang="ko" data-theme="dark"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><link rel="icon" href="data:,"><title>${model.code} · RAIBIT SERVER</title><style>${HOSTED_ERROR_CSS}</style></head><body><main><section aria-labelledby="error-title"><div class="signal-wrap" aria-hidden="true"><div class="signal">${model.code}</div></div><div class="copy"><p class="eyebrow">RAIBIT SERVER · ${escapeHtml(model.eyebrow)}</p><h1 id="error-title">${escapeHtml(model.title)}</h1><p class="description">${escapeHtml(model.description)}</p>${details ? `<dl class="details">${details}</dl>` : ''}<div class="actions"><a href="${escapeHtml(actionHref)}">${escapeHtml(actionLabel)}</a></div></div></section></main></body></html>`;
}
...
const HOSTED_ERROR_CSS = `:root{color-scheme:dark;--canvas:#0b0e12;--border:#2b333c;--text:#eef2f6;--soft:#aeb7c0;--muted:#87929e;--primary:#68df88;--primary-ink:#08250f}*{box-sizing:border-box}html,body{min-width:320px;min-height:100%;margin:0}body{background:radial-gradient(circle at 10% 8%,rgb(104 223 136 / 9%),transparent 30rem),radial-gradient(circle at 92% 92%,rgb(100 185 238 / 7%),transparent 34rem),var(--canvas);color:var(--text);font-family:"Noto Sans KR",Inter,system-ui,sans-serif}main{min-height:100dvh;padding:clamp(28px,4vw,64px);overflow:hidden}section{width:100%;min-height:calc(100dvh - clamp(56px,8vw,128px));display:grid;grid-template-columns:minmax(0,.95fr) minmax(420px,1.05fr);align-items:center}.signal-wrap{min-width:0;display:flex;justify-content:flex-end;padding-right:clamp(36px,5vw,80px)}.signal{color:var(--primary);font:700 clamp(180px,25vw,400px)/.76 "JetBrains Mono",ui-monospace,monospace;letter-spacing:-.11em;text-align:right;text-shadow:0 0 56px rgb(104 223 136 / 10%)}.copy{min-width:0;max-width:760px;padding:clamp(20px,4vw,56px) 0 clamp(20px,4vw,56px) clamp(36px,6vw,96px);border-left:1px solid var(--border)}.eyebrow{margin:0 0 18px;color:var(--primary);font-size:11px;font-weight:700;letter-spacing:.14em}h1{max-width:13ch;margin:0;font-size:clamp(44px,5vw,72px);line-height:1.08;letter-spacing:-.055em;overflow-wrap:break-word;word-break:keep-all}.description{max-width:620px;margin:22px 0 0;color:var(--soft);font-size:17px;line-height:1.7;overflow-wrap:break-word;word-break:keep-all}.details{display:grid;grid-template-columns:auto minmax(0,1fr);gap:8px 18px;max-width:620px;margin:36px 0 0;padding-top:22px;border-top:1px solid var(--border);color:var(--muted);font-size:12px}.details>div{display:contents}.details dt,.details dd{min-width:0;margin:0}.details code{display:block;overflow:hidden;color:var(--soft);font:12px/1.5 "JetBrains Mono",ui-monospace,monospace;text-overflow:ellipsis;white-space:nowrap}.actions{margin-top:36px}a{min-height:44px;width:fit-content;display:inline-flex;align-items:center;justify-content:center;padding:0 17px;border-radius:9px;background:var(--primary);color:var(--primary-ink);font-size:13px;font-weight:750;text-decoration:none}a:focus-visible{outline:2px solid var(--text);outline-offset:3px}@media(max-width:960px){main{padding:clamp(24px,5vw,44px);overflow:auto}section{min-height:calc(100dvh - clamp(48px,10vw,88px));grid-template-columns:1fr;grid-template-rows:auto minmax(0,1fr);align-items:stretch}.signal-wrap{justify-content:flex-start;padding:0 0 clamp(20px,4vw,32px)}.signal{font-size:clamp(112px,21vw,168px);text-align:left}.copy{max-width:none;padding:clamp(24px,4vw,36px) 0 0;border-top:1px solid var(--border);border-left:0}h1{max-width:16ch}}@media(max-width:720px){body{background:radial-gradient(circle at 14% 0,rgb(104 223 136 / 10%),transparent 22rem),var(--canvas)}main{min-height:100svh;padding:0;overflow:auto}section{min-height:100svh;padding:max(24px,env(safe-area-inset-top)) 20px max(24px,env(safe-area-inset-bottom));grid-template-rows:auto minmax(0,1fr)}.signal-wrap{padding-bottom:18px}.signal{font-size:clamp(112px,34vw,144px);line-height:.8}.copy{min-height:0;display:flex;flex-direction:column;padding-top:22px}.eyebrow{margin-bottom:12px;font-size:10px}h1{max-width:100%;font-size:clamp(30px,8.7vw,36px);line-height:1.14;letter-spacing:-.045em}.description{margin-top:16px;font-size:15px;line-height:1.7}.details{grid-template-columns:1fr;gap:5px;margin-top:24px;padding-top:18px}.details>div{display:grid;gap:5px}.details dd{margin-bottom:10px}.actions{margin-top:auto;padding-top:28px}.actions a{width:100%;min-height:48px}}`;
