...
export class GitHubIntegrationService implements OnModuleInit, OnModuleDestroy {
  ...
  attachGitHub(projectId: string, serviceId: string, input: Record<string, any>, subject: Record<string, any>, selector: Record<string, any> = {}) { return this.controlPlane.attachGitHub(projectId, serviceId, input, subject, selector); }
  ...
  syncGitHubRepository(repositoryId: string, input: Record<string, any>, subject: Record<string, any>, selector: Record<string, unknown> = {}) { return this.controlPlane.syncGitHubRepository(repositoryId, input, subject, selector); }
}
