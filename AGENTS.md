...
- Generated tenant URLs use the organization slug as the flat single-label route tenant under the base domain: `apps--<organization>--<project>.raibitserver.app`, `preview--pr-<number>--<organization>--<project>.raibitserver.app`, `console--...`, and `resources--...`.
