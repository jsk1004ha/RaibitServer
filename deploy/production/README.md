...
- `console`, `console--*`, `resources--*`에는 Cloudflare Access를 추가하고, Dashboard의 HttpOnly JWT 세션 및 앱 내부 RBAC를 유지합니다. 필요하면 `RAIBITSERVER_DASHBOARD_BASIC_AUTH`를 추가 방어선으로 설정합니다.
