...
export const RUNTIME_KEY_CATALOG = Object.freeze([
  ...
  { name: 'RAIBITSERVER_GITHUB_APP_SLUG', category: 'github', required: false, secret: false, description: 'GitHub App slug used by the one-button installation flow' },
  ...
  { name: 'RAIBITSERVER_GITHUB_CALLBACK_URL', category: 'github', required: false, secret: false, description: 'Dashboard GitHub App setup callback URL' },
  { name: 'RAIBITSERVER_GITHUB_REDIRECT_URI', category: 'github', required: false, secret: false, description: 'Dashboard account-login OAuth callback URL' },
