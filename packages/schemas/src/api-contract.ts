...
import { OrganizationCreateRequestSchema, OrganizationCreatedSchema } from './organization-create.ts';
...
import { EnvironmentCreateSchema, EnvironmentDeleteSchema, EnvironmentDeletedViewSchema, EnvironmentListViewSchema, EnvironmentSelectorSchema, EnvironmentViewSchema } from './environment-management.ts';
...
const environment = project.extend({ environmentId: id });
...
const pagedEnvironmentQuery = EnvironmentSelectorSchema.safeExtend(M.PageQuery.shape);
const backupListEnvironmentQuery = EnvironmentSelectorSchema.safeExtend(ResourceBackupListSchema.unwrap().shape);
const browseEnvironmentQuery = EnvironmentSelectorSchema.safeExtend(M.BrowseInput.shape);
const serviceEnvironmentInput = M.ServiceInput.safeExtend({
  ...EnvironmentSelectorSchema.shape,
  environment: z.union([z.record(z.string(), z.string()), z.enum(['prod', 'dev'])]).optional(),
}).refine(
  (value) => typeof value.environment !== 'string' || value.environmentKind === undefined || value.environment === value.environmentKind,
  'environment selectors disagree',
);
const resourceEnvironmentInput = M.ResourceInput.safeExtend(EnvironmentSelectorSchema.shape).refine(
  (value) => value.environment === undefined || value.environmentKind === undefined || value.environment === value.environmentKind,
  'environment selectors disagree',
);
...
export const apiOperations = {
  'deployments-retry': operation({ method: 'post', path: '/deployments/{deploymentId}/retry', status: 202, permission: 'deploy:run', input: input(deployment, EnvironmentSelectorSchema, DeploymentOperationInputSchema), response: M.DeploymentOperationResult }),
  'services-redeploy': operation({ method: 'post', path: '/services/{serviceId}/redeploy', status: 202, permission: 'deploy:run', input: input(service, EnvironmentSelectorSchema, DeploymentOperationInputSchema), response: M.DeploymentOperationResult }),
  ...
  'organizations-post': operation({ method: 'post', path: '/organizations', status: 201, permission: 'project:read', input: input(M.Empty, M.Empty, OrganizationCreateRequestSchema), response: OrganizationCreatedSchema }),
  ...
  'projects-overview': operation({ method: 'get', path: '/projects/{projectId}/overview', status: 200, permission: 'project:read', input: input(project, EnvironmentSelectorSchema, M.Empty), response: z.object({ project: M.Project, services: z.array(M.Service), resources: z.array(M.Resource), deployments: z.array(M.Deployment) }) }),
  'projects-environments': operation({ method: 'get', path: '/projects/{projectId}/environments', status: 200, permission: 'project:read', input: input(project, M.Empty, M.Empty), response: EnvironmentListViewSchema }),
  'projects-environments-post': operation({ method: 'post', path: '/projects/{projectId}/environments', status: 201, permission: 'environment:manage', input: input(project, M.Empty, EnvironmentCreateSchema), response: EnvironmentViewSchema }),
  'projects-environments-delete': operation({ method: 'delete', path: '/projects/{projectId}/environments/{environmentId}', status: 200, permission: 'environment:manage', input: input(environment, M.Empty, EnvironmentDeleteSchema), response: EnvironmentDeletedViewSchema }),
  'services-list': operation({ method: 'get', path: '/projects/{projectId}/services', status: 200, permission: 'project:read', input: input(project, pagedEnvironmentQuery, M.Empty), response: M.Services }),
  'services-create': operation({ method: 'post', path: '/projects/{projectId}/services', status: 201, permission: 'service:create', input: input(project, M.Empty, serviceEnvironmentInput), response: M.Service }),
  'services-get': operation({ method: 'get', path: '/services/{serviceId}', status: 200, permission: 'project:read', input: input(service, EnvironmentSelectorSchema, M.Empty), response: M.Service }),
  'services-update': operation({ method: 'patch', path: '/services/{serviceId}', status: 200, permission: 'service:update', input: input(service, EnvironmentSelectorSchema, ServiceUpdateSchema), response: M.Service }),
  'services-settings-get': operation({ method: 'get', path: '/services/{serviceId}/settings', status: 200, permission: 'project:read', input: input(service, EnvironmentSelectorSchema, M.Empty), response: ServiceSettingsSnapshotSchema }),
  'services-settings-preview': operation({ method: 'post', path: '/services/{serviceId}/settings/preview', status: 200, permission: 'service:update', input: input(service, EnvironmentSelectorSchema, ServiceSettingsMutationSchema), response: ServiceSettingsPreviewSchema }),
  'services-settings-update': operation({ method: 'patch', path: '/services/{serviceId}/settings', status: 200, permission: 'service:update', input: input(service, EnvironmentSelectorSchema, ServiceSettingsMutationSchema), response: ServiceSettingsSnapshotSchema }),
  'services-replacements-create': operation({ method: 'post', path: '/services/{serviceId}/replacements', status: 201, permission: 'service:create', input: input(service, EnvironmentSelectorSchema, ServiceReplacementInputSchema), response: ServiceReplacementResultSchema }),
  'services-delete': operation({ method: 'delete', path: '/services/{serviceId}', status: 200, permission: 'project:delete', input: input(service, EnvironmentSelectorSchema, M.Empty), response: M.Deletion }),
  'domains-list': operation({ method: 'get', path: '/projects/{projectId}/domains', status: 200, permission: 'domain:read', input: input(project, EnvironmentSelectorSchema, M.Empty), response: CustomDomainListSchema }),
  ...
  'domains-status': operation({ method: 'get', path: '/domains/{domainId}', status: 200, permission: 'domain:read', input: input(domain, EnvironmentSelectorSchema, M.Empty), response: CustomDomainSchema }),
  'domains-rotate': operation({ method: 'post', path: '/domains/{domainId}/rotate', status: 202, permission: 'domain:manage', input: input(domain, EnvironmentSelectorSchema, CustomDomainRotateSchema), response: CustomDomainChallengeSchema }),
  'domains-verify': operation({ method: 'post', path: '/domains/{domainId}/verify', status: 202, permission: 'domain:verify', input: input(domain, EnvironmentSelectorSchema, CustomDomainMutationSchema), response: CustomDomainSchema }),
  'domains-delete': operation({ method: 'delete', path: '/domains/{domainId}', status: 202, permission: 'domain:manage', input: input(domain, EnvironmentSelectorSchema, CustomDomainMutationSchema), response: CustomDomainSchema }),
  'project-deployments-list': operation({ method: 'get', path: '/projects/{projectId}/services/{serviceId}/deployments', status: 200, permission: 'project:read', input: input(scopedService, pagedEnvironmentQuery, M.Empty), response: M.Deployments }),
  ...
  'project-deployments-create': operation({ method: 'post', path: '/projects/{projectId}/services/{serviceId}/deployments', status: 202, permission: 'deploy:run', input: input(scopedService, EnvironmentSelectorSchema, M.DeploymentInput), response: M.DeploymentMutationResult }),
  'deployments-list': operation({ method: 'get', path: '/services/{serviceId}/deployments', status: 200, permission: 'project:read', input: input(service, pagedEnvironmentQuery, M.Empty), response: M.Deployments }),
  'deployments-create': operation({ method: 'post', path: '/services/{serviceId}/deployments', status: 202, permission: 'deploy:run', input: input(service, EnvironmentSelectorSchema, M.DeploymentInput), response: M.DeploymentMutationResult }),
  'deployments-get': operation({ method: 'get', path: '/deployments/{deploymentId}', status: 200, permission: 'project:read', input: input(deployment, EnvironmentSelectorSchema, M.Empty), response: M.Deployment.extend(DeploymentHistoryRowSchema.shape) }),
  'deployments-status': operation({ method: 'patch', path: '/deployments/{deploymentId}/status', status: 200, permission: 'deploy:run', input: input(deployment, EnvironmentSelectorSchema, M.StatusInput), response: M.Deployment }),
  'deployments-status-post': operation({ method: 'post', path: '/deployments/{deploymentId}/status', status: 201, permission: 'deploy:run', input: input(deployment, EnvironmentSelectorSchema, M.StatusInput), response: M.Deployment }),
  'deployments-cancel': operation({ method: 'post', path: '/deployments/{deploymentId}/cancel', status: 200, permission: 'deploy:run', input: input(deployment, EnvironmentSelectorSchema, M.Empty), response: z.object({ operationId: id, status: z.string(), streamHref: z.string(), deployment: M.Deployment }) }),
  'deployments-rollback': operation({ method: 'post', path: '/deployments/{deploymentId}/rollback', status: 202, permission: 'deploy:run', input: input(deployment, EnvironmentSelectorSchema, M.Confirmation.extend({ previousDeploymentId: id.optional(), imageUrl: z.string().optional() })), response: z.object({ operationId: id, status: z.string(), streamHref: z.string(), deployment: M.Deployment, rollbackOfDeploymentId: id, previousDeployment: M.Deployment.nullable(), workflowJob: M.JsonFields }) }),
  'deployments-preview-cleanup': operation({ method: 'post', path: '/deployments/{deploymentId}/preview-cleanup', status: 202, permission: 'deploy:run', input: input(deployment, EnvironmentSelectorSchema, M.Confirmation), response: M.PreviewCleanupResult }),
  'deployments-logs': operation({ method: 'get', path: '/deployments/{deploymentId}/logs', status: 200, permission: 'logs:read', input: input(deployment, pagedEnvironmentQuery, M.Empty), response: M.Logs }),
  'deployments-events': operation({ method: 'get', path: '/deployments/{deploymentId}/events', status: 200, permission: 'logs:read', input: input(deployment, pagedEnvironmentQuery, M.Empty), response: M.Events }),
  'deployments-stream': operation({ method: 'get', path: '/deployments/{deploymentId}/stream', status: 200, permission: 'logs:read', input: input(deployment, EnvironmentSelectorSchema, M.Empty), response: M.DeploymentStream, stream: 'deployment.snapshot' }),
  'services-logs': operation({ method: 'get', path: '/services/{serviceId}/logs', status: 200, permission: 'logs:read', input: input(service, pagedEnvironmentQuery, M.Empty), response: M.Logs }),
  'services-logs-stream': operation({ method: 'get', path: '/services/{serviceId}/logs/stream', status: 200, permission: 'logs:read', input: input(service, EnvironmentSelectorSchema, M.Empty), response: M.ServiceStream, stream: 'service.logs.snapshot' }),
  ...
  'resources-list': operation({ method: 'get', path: '/projects/{projectId}/resources', status: 200, permission: 'project:read', input: input(project, pagedEnvironmentQuery, M.Empty), response: M.Resources }),
  'resources-create': operation({ method: 'post', path: '/projects/{projectId}/resources', status: 201, permission: 'db:create', input: input(project, M.Empty, resourceEnvironmentInput), response: M.Resource }),
  'resources-get': operation({ method: 'get', path: '/resources/{resourceId}', status: 200, permission: 'project:read', input: input(resource, EnvironmentSelectorSchema, M.Empty), response: M.Resource }),
  'resources-update': operation({ method: 'patch', path: '/resources/{resourceId}', status: 200, permission: 'db:create', input: input(resource, EnvironmentSelectorSchema, ResourceUpdateSchema), response: M.Resource }),
  'resources-delete': operation({ method: 'delete', path: '/resources/{resourceId}', status: 200, permission: 'db:delete', input: input(resource, EnvironmentSelectorSchema, M.Empty), response: M.Deletion }),
  'resources-attach': operation({ method: 'post', path: '/resources/{resourceId}/attach', status: 201, permission: 'db:create', input: input(resource, EnvironmentSelectorSchema, z.object({ serviceId: id, envPrefix: z.string().optional() })), response: z.object({ operationId: id, status: z.literal('ATTACHED'), resourceId: id, serviceId: id }).catchall(z.json()) }),
  'resources-provision': operation({ method: 'post', path: '/resources/{resourceId}/provision', status: 201, permission: 'db:create', input: input(resource, EnvironmentSelectorSchema, M.ResourceProvisionInput), response: z.object({ operationId: id.optional(), status: z.string().optional(), resource: M.Resource, result: M.ResourceProvisionResult }) }),
  'resource-backups-create': operation({ method: 'post', path: '/resources/{resourceId}/backups', status: 202, permission: 'backup:manage', input: input(resource, EnvironmentSelectorSchema, ResourceBackupCreateSchema), response: ResourceBackupViewSchema }),
  'resource-backups-list': operation({ method: 'get', path: '/resources/{resourceId}/backups', status: 200, permission: 'backup:manage', input: input(resource, backupListEnvironmentQuery, M.Empty), response: ResourceBackupListViewSchema }),
  'resource-backups-delete': operation({ method: 'delete', path: '/backups/{backupId}', status: 200, permission: 'backup:manage', input: input(backup, EnvironmentSelectorSchema, ResourceBackupDeleteSchema), response: ResourceBackupViewSchema }),
  'backup-restores-create': operation({ method: 'post', path: '/backups/{backupId}/restores', status: 202, permission: 'backup:restore', input: input(backup, EnvironmentSelectorSchema, ResourceRestoreCreateSchema), response: ResourceRestoreViewSchema }),
  'restores-get': operation({ method: 'get', path: '/restores/{restoreId}', status: 200, permission: 'backup:restore', input: input(restore, EnvironmentSelectorSchema, M.Empty), response: ResourceRestoreViewSchema }),
  'console-schema': operation({ method: 'get', path: '/resources/{resourceId}/console/schema', status: 200, permission: 'db:schema:read', input: input(resource, browseEnvironmentQuery, M.Empty), response: M.ConsoleResult.extend({ schema: M.JsonFields }) }),
  'console-tables': operation({ method: 'get', path: '/resources/{resourceId}/console/tables', status: 200, permission: 'db:schema:read', input: input(resource, browseEnvironmentQuery, M.Empty), response: M.ConsoleResult.extend({ tables: z.array(z.json()) }) }),
  'console-table': operation({ method: 'get', path: '/resources/{resourceId}/console/tables/{table}', status: 200, permission: 'db:data:read', input: input(resource.extend({ table: id }), browseEnvironmentQuery, M.Empty), response: M.ConsoleResult.extend({ rows: z.array(z.json()), rowCount: z.number() }) }),
  'console-collections': operation({ method: 'get', path: '/resources/{resourceId}/console/collections', status: 200, permission: 'db:schema:read', input: input(resource, browseEnvironmentQuery, M.Empty), response: M.ConsoleResult.extend({ collections: z.array(z.json()) }) }),
  'console-keys': operation({ method: 'get', path: '/resources/{resourceId}/console/keys', status: 200, permission: 'db:schema:read', input: input(resource, browseEnvironmentQuery, M.Empty), response: M.ConsoleResult.extend({ keys: z.array(z.json()) }) }),
  'console-query': operation({ method: 'post', path: '/resources/{resourceId}/console/query', status: 201, permission: 'db:data:read', input: input(resource, EnvironmentSelectorSchema, query), response: M.ConsoleResult }),
  'console-command': operation({ method: 'post', path: '/resources/{resourceId}/console/command', status: 201, permission: 'db:query:write', input: input(resource, EnvironmentSelectorSchema, query.partial().extend({ command: z.string().min(1) })), response: M.ConsoleResult }),
  'console-browse': operation({ method: 'post', path: '/resources/{resourceId}/console/browse', status: 201, permission: 'db:data:read', input: input(resource, EnvironmentSelectorSchema, M.BrowseInput), response: M.ConsoleResult }),
  'environment-list': operation({ method: 'get', path: '/projects/{projectId}/services/{serviceId}/env', status: 200, permission: 'env:read', input: input(scopedService, EnvironmentSelectorSchema, M.Empty), response: M.Environment }),
  'environment-upsert': operation({ method: 'post', path: '/projects/{projectId}/services/{serviceId}/env', status: 201, permission: 'env:write-limited', input: input(scopedService, EnvironmentSelectorSchema, z.object({ entries: z.array(z.object({ key: id, value: z.string(), isSecret: z.boolean().optional() })), source: z.string().optional() })), response: M.Environment }),
  'environment-upload': operation({ method: 'post', path: '/projects/{projectId}/services/{serviceId}/env-file', status: 201, permission: 'env:write-limited', input: input(scopedService, EnvironmentSelectorSchema, z.object({ filename: z.string(), content: z.string() })), response: M.Environment }),
  ...
  'github-attach': operation({ method: 'post', path: '/projects/{projectId}/services/{serviceId}/github', status: 201, permission: 'deploy:run', input: input(scopedService, EnvironmentSelectorSchema, M.GithubAttach), response: z.object({ service: M.Service, github: M.JsonFields }) }),
  'github-repositories': operation({ method: 'get', path: '/github/installations/{installationId}/repositories', status: 200, permission: 'project:read', input: input(z.object({ installationId: id }), z.object({ cursor: z.string().optional(), q: z.string().max(200).optional() }), M.Empty), response: M.GitHubCatalogPage }),
  'github-repositories-refresh': operation({ method: 'post', path: '/github/installations/{installationId}/repositories/refresh', status: 200, permission: 'github:refresh', input: input(z.object({ installationId: id }), M.Empty, z.object({ expectedIntegrationVersion: z.number().int().positive(), expectedGeneration: z.number().int().nonnegative() }).strict()), response: z.object({ refreshed: z.literal(true), repositoryCount: z.number().int().nonnegative(), generation: z.number().int().nonnegative(), refreshStatus: z.literal('IDLE'), lastSuccessfulSyncAt: z.iso.datetime(), staleAt: z.null() }).strict() }),
  ...
  'github-import': operation({ method: 'post', path: '/github/repositories/import', status: 201, permission: 'deploy:run', input: input(M.Empty, M.Empty, M.GithubAttach.extend({ projectId: id, serviceName: z.string().optional(), serviceSlug: z.string().regex(/^[a-z0-9](?:[-a-z0-9]*[a-z0-9])?$/).max(63).optional(), environmentId: id.optional(), environmentKind: z.enum(['prod', 'dev']).optional() })), response: z.object({ service: M.Service }).catchall(z.json()) }),
  'github-sync': operation({ method: 'post', path: '/github/repositories/{repositoryId}/sync', status: 202, permission: 'deploy:run', input: input(z.object({ repositoryId: id }), EnvironmentSelectorSchema, z.object({ integrationId: id.optional(), branch: z.string().optional(), expectedDefaultBranch: z.string().optional(), expectedCatalogGeneration: z.number().int().nonnegative().optional(), idempotencyKey: z.string().min(1).max(128).regex(/^[A-Za-z0-9._:-]+$/).optional() }).strict()), response: z.object({ repository: z.string(), services: z.array(M.Service), workflowJob: M.JsonFields }) }),
